      ...
      <SafeAreaView className="space-y-4">
        <View className="mx-4 flex-row justify-between items-center">
          ...
          <TouchableOpacity className="rounded-full border-2 border-white p-2">
            <HeartIcon size="25" strokeWidth={1.2} color="white" />
          </TouchableOpacity>
        </View>
        <View
        ...
        <View className="px-4 flex-row justify-between items-center">
          ...
          >
            N {Math.floor(item.price * 700)}
          </Text>
        </View>

        <View className="px-4 space-y-2">
          <Text
            style={{ color: themeColors.text, marginTop: 15 }}
        ...
        <View className="px-4 space-y-2 mb-5" style={{ marginTop: 20 }}>
          <Text
            style={{ color: themeColors.text }}
            className="text-lg font-bold"
          >
        ...
        <View
          style={{ marginTop: 20 }}
          className="flex-row justify-between items-center mx-4 pt-5"
        >
